...
import 'modo_arrendatario_page.dart';
...
class _ProfilePageState extends State<ProfilePage> {
                  ...
                  children: [
                    ...
                    Expanded(
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                          Text('Activar modo arrendatario',
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              style: GoogleFonts.poppins(
                          ...
                          Text('Renta tu vehículo y gana dinero',
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              style: GoogleFonts.poppins(
                                  fontSize: isSmallPhone ? 9 : 11,
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const ModoArrendatarioPage(),
                          ),
                        );
                      },
  ...
  Widget _buildBenefitItem(String icon, String text, bool isSmallPhone) {
    return Row(
      children: [
        Container(
