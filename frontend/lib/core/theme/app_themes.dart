...
class AppThemes {
  ...
  // ── Helpers ────────────────────────────────────────────────────
  static TextTheme _textTheme(Color body) => GoogleFonts.poppinsTextTheme()
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        inputDecorationTheme: _inputTheme(darkSurfaceHi, darkBorder)
            .copyWith(
          hintStyle:
              GoogleFonts.inter(color: darkTextSub, fontSize: 14),
        ),
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            backgroundColor: primaryIndigo,
