...
/// Define la responsabilidad de `PaymentAccessUseCase` dentro de este módulo.
class PaymentAccessUseCase {
  /// Crea una instancia y prepara el estado inicial de `PaymentAccessUseCase`.
  ...
  /// Obtiene la información asociada a obtener tarjeta last4.
